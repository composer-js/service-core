...
* [ScriptLanguage](enums/scriptlanguage.md)
* [ScriptSource](enums/scriptsource.md)
* [ScriptType](enums/scripttype.md)
...
* [ScriptManager](classes/scriptmanager.md)
* [ScriptMongo](classes/scriptmongo.md)
* [ScriptRouteMongo](classes/scriptroutemongo.md)
* [ScriptRouteSQL](classes/scriptroutesql.md)
* [ScriptSQL](classes/scriptsql.md)
* [ScriptUtils](classes/scriptutils.md)
...
• **tsc**: *any* = require("ts-node").register()

Defined in src/scripts/ScriptUtils.ts:15
...
Defined in src/scripts/ScriptUtils.ts:13

Defined in src/scripts/ScriptManager.ts:13

Defined in src/models/SimpleEntity.ts:6

Defined in src/ObjectFactory.ts:5
...
Defined in src/decorators/ObjectDecorators.ts:38
...
▸ **OnEvent**(`type?`: string | string[]): *(Anonymous function)*

Defined in src/decorators/ObjectDecorators.ts:54
...
Name | Type | Description |
------ | ------ | ------ |
`type?` | string &#124; string[] | The name or list of names corresponding to events that the function will handle.  |
